  ...
  return (
    <div className="overflow-x-hidden mb-32">
      ...
      <div className="2xl:px-44 xl:px-28 lg:px-20 md:px-16 px-10 md:pt-20 pt-6 flex flex-col justify-center">
        ...
        >
          <div className="md:w-[50rem] flex w-full">
            <Controller />
            <hr className=" self-center 2xl:w-72 lg:w-72 md:w-24 md:visible collapse border-t-4 border-dotted border-[#262626] mx-4 rounded-3xl" />
            <Tabs
